      ...
      <nav>
        ...
        <div class="parent">
            ...
            <div class="child" id="abilities">
                ...
                <input type="number" id="strength" name="strength" min="0" max="20" value="0" required><br>
            ...
            <div class="child" id="skills">
                    ...
                    <input type="number" id="acrobatics" name="acrobatics" min="0" value="0" required><br>

                    <label for="animalHandling">Animal Handling:</label>
                    <input type="number" id="animalHandling" name="animalHandling" min="0" value="0" required><br>

                    <label for="arcana">Arcana:</label>
                    <input type="number" id="arcana" name="arcana" min="0" value="0" required><br>

                    <label for="athletics">Athletics:</label>
                    <input type="number" id="athletics" name="athletics" min="0"  value="0" required><br>

                    <label for="deception">Deception:</label>
                    <input type="number" id="deception" name="deception" min="0" value="0" required><br>

                    <label for="history">History:</label>
                    <input type="number" id="history" name="history" min="0" value="0" required><br>

                    <label for="insight">Insight:</label>
                    <input type="number" id="insight" name="insight" min="0" value="0" required><br>

                    <label for="intimidation">Intimidation:</label>
                    <input type="number" id="intimidation" name="intimidation" min="0" value="0" required><br>

                    <label for="investigation">Investigation:</label>
                    <input type="number" id="investigation" name="investigation" min="0" value="0" required><br>

                    <label for="medicine">Medicine:</label>
                    <input type="number" id="medicine" name="medicine" min="0" value="0" required><br>

                    <label for="nature">Nature:</label>
                    <input type="number" id="nature" name="nature" min="0" value="0" required><br>

                    <label for="perception">Perception:</label>
                    <input type="number" id="perception" name="perception" min="0" value="0" required><br>

                    <label for="performance">Performance:</label>
                    <input type="number" id="performance" name="performance" min="0" value="0" required><br>

                    <label for="persuasion">Persuasion:</label>
                    <input type="number" id="persuasion" name="persuasion" min="0" value="0" required><br>

                    <label for="religion">Religion:</label>
                    <input type="number" id="religion" name="religion" min="0" value="0" required><br>

                    <label for="sleightOfHand">Sleight of Hand:</label>
                    <input type="number" id="sleightOfHand" name="sleightOfHand" min="0" value="0" required><br>

                    <label for="stealth">Stealth:</label>
                    <input type="number" id="stealth" name="stealth" min="0" value="0" required><br>

                    <label for="survival">Survival:</label> 
                    <input type="number" id="survival" name="survival" min="0" value="0" required><br>
